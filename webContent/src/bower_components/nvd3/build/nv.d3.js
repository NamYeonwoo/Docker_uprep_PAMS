...
nv.models.tooltip = function() {
    ...
    Example Format of data:
    {
        ...
        value: "August 2009",
        series: [
            {key: "Series 1", value: "Value 1", color: "#ffffff"},
    ...
    */
    ...
    var contentGenerator = function(d) {
        ...
        trowEnter.selectAll("td").each(function(p) {
            if (p.highlight) {
                var opacityScale = d3.scale.linear().domain([0,1]).range(["#000000",p.color]);
                var opacity = 0.6;
                d3.select(this)
...
nv.models.furiousLegend = function() {
    ...
    function chart(selection) {
        ...
        function setTextColor(d,i) {
            if(vers != 'furious') return '#ffffff';
            if(expanded) {
                return d.disengaged ? color(d,i) : '#000000';
            } else if (!expanded) {
                return !!d.disabled ? color(d,i) : '#000000';
            }
        }

        function setBGColor(d,i) {
            if(expanded && vers == 'furious') {
                return d.disengaged ? '#000000' : color(d,i);
            } else {
                return !!d.disabled ? '#000000' : color(d,i);
            }
        }
...
nv.models.legend = function() {
    ...
    function chart(selection) {
        ...
        function setTextColor(d,i) {
            if(vers != 'furious') return '#ffffff';
            if(expanded) {
                return d.disengaged ? '#ffffff' : '#000000';
            } else if (!expanded) {
                if(!d.color) d.color = color(d,i);
                return !!d.disabled ? d.color : '#000000';
            }
        }
...
nv.models.sparkline = function() {
    ...
    var margin = {top: 2, right: 0, bottom: 2, left: 0}
        ...
        , getX = function(d) { return d.x }
        , getY = function(d) { return d.y }
        , color = nv.utils.getColor(['#ffffff'])
        , xDomain
        , yDomain
        , xRange
        , yRange
